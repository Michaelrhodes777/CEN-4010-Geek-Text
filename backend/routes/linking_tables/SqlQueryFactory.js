...
class ReadByCompositeId {
    constructor(Model, currentKeys) {
        this.sqlString = Model.verifyCompositePrimaryKeyString(Model);
        this.values = currentKeys;
    }
